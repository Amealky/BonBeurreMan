APP_NAME = BonBeurreMan

#SFML variables
SFML_FOLDER = {YOUR SFML FOLDER INSTALLATION HERE}
LIBS = -lsfml-graphics -lsfml-window -lsfml-system -lsfml-audio -lsfml-network

#COMPILERS variables and flags
COMPILER = g++
COMPILER_FLAG = -std=c++17
INCLUDES_FLAG = -I $(SFML_FOLDER)/include
LIBRARIES_FLAG = -L $(SFML_FOLDER)/lib $(LIBS)
...
ifeq ($(OS), Windows_NT)
	...
	LIBRARIES_FLAG = -L $(SFML_FOLDER)/lib -mwindows -lmingw32 $(LIBS)
